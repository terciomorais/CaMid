...
public class CloudManagerTester{
    ...
    public static void main(String[] args){
        ...
        NamingStub  ns = new NamingStub("10.66.66.10", 1111);
        ...
        ds.setHost("10.66.66.20");
        ds.setPort(1212);
        ds.setFeHost("10.66.66.20");
        ds.setFePort(1212);
        ns.bind("delay", ds);
        /* CloudManagerServiceStub cmss = (CloudManagerServiceStub)ns.lookup("management");
        cmss.setForwarded(false);
        cmss.removeServiceEndpoint("delay", new EndPoint("10.66.66.11:1313"));
        ns.unbind("delay", new EndPoint("10.66.66.11:1313"));
 */
/*      Set<EndPoint> endpoints = new HashSet<EndPoint>();
        
        endpoints.add(new EndPoint("10.66.66.20:1212"));
        endpoints.add(new EndPoint("10.66.66.10:1212"));
